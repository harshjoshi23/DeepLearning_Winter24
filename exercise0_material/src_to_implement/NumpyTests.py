...
class TestGen(unittest.TestCase):
    def setUp(self):
        # Setting file_path and label_path using relative paths from the current script location
        self.file_path = './data/exercise_data'  # Relative path to the exercise data folder
        self.label_path = './data/Labels.json'  # Relative path to the Labels.json within the data folder
